...
<a href="mailto:L.Cruz@tudelft.nl?subject=Pre-order%20The%20Green%20Codeck&body=Hi%2C%0A%0AI%20would%20like%20to%20pre-order%20The%20Green%20Codeck%20card%20set.%0A%0APlease%20let%20me%20know%20about%20availability%20and%20next%20steps.%0A%0AThank%20you!" class="custom-btn">
...
## How It Works
The Green Codeck is available both physically and digitally. You can start using it right now by [browsing the patterns](/the-green-codeck/the-patterns/) or [shuffling a random card](/the-green-codeck/shuffle/). Each card represents a specific best practice or approach that can be applied to your projects, covering areas from algorithm optimization to system design considerations.
